...
public class HabitHistoryControllerTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testAdd() throws Exception{
        ...
        while (!HabitHistoryController.getInstance().isEmpty()){HabitHistoryController.getInstance().remove(0);}

        assertTrue("HabitHistory should have been empty", HabitHistoryController.getInstance().isEmpty());
        ...
        assertFalse("HabitHistory should not have been empty", HabitHistoryController.getInstance().isEmpty());

        HabitHistoryController.getInstance().remove(he);
        assertTrue("HabitHistory should be empty", HabitHistoryController.getInstance().isEmpty());
    }
    ...
    public void testGet() throws  Exception{
        ...
        HabitEvent returnedHabitEvent =
                HabitHistoryController.getInstance().get(HabitHistoryController.getInstance().indexOf(he.getId()));
    ...
    public void testRemove() throws Exception{
        ...
        assertTrue("HabitHistory doesn't contain the HabitEvent",
                HabitHistoryController.getInstance().contains(he));
        HabitEvent removedHabitEvent = HabitHistoryController.getInstance().remove(he);
    ...
    public void testAddAll() throws Exception{
        ...
        HabitHistoryController.getInstance().addAllHabitEvents(habitEvents);

        size = HabitHistoryController.getInstance().size();
        Log.d("Size:", String.valueOf(size));
